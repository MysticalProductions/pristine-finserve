...
CREATE TABLE `pf_partners` (
  ...
  `type` ENUM('bank','nbfc','other') DEFAULT 'bank',
  `description` TEXT NULL,
...
('contact_phone', '+91 9899360744', 'text', 'contact'),
('contact_address', 'RT-89 & 104, Tower C, Urbtech Trade Center, B Block, Sector 132, Noida, Uttar Pradesh-201304', 'textarea', 'contact'),
('email', 'info@pristinefinserve.com', 'text', 'contact'),
('phone', '+91 9899360744', 'text', 'contact'),
('address', 'RT-89 & 104, Tower C, Urbtech Trade Center, B Block, Sector 132, Noida, Uttar Pradesh-201304', 'textarea', 'contact'),
('working_hours', 'Mon - Sat: 9:30 AM - 7:00 PM', 'text', 'contact'),
('contact_hours', 'Mon - Sat: 9:30 AM - 7:00 PM', 'text', 'contact'),
('contact_hours_alt', 'Sunday: Closed', 'text', 'contact'),
('whatsapp', '919899360744', 'text', 'contact'),
('facebook_url', 'https://facebook.com/pristinefinserve', 'text', 'social'),
('twitter_url', 'https://twitter.com/pristinefinserve', 'text', 'social'),
('linkedin_url', 'https://linkedin.com/company/pristinefinserve', 'text', 'social'),
('instagram_url', 'https://instagram.com/pristinefinserve', 'text', 'social'),
('youtube_url', 'https://youtube.com/@pristinefinserve', 'text', 'social'),
('instagram_username', 'pristinefinserve', 'text', 'social'),
('social_facebook', 'https://facebook.com/pristinefinserve', 'text', 'social'),
('social_twitter', 'https://twitter.com/pristinefinserve', 'text', 'social'),
('social_linkedin', 'https://linkedin.com/company/pristinefinserve', 'text', 'social'),
('social_instagram', 'https://instagram.com/pristinefinserve', 'text', 'social'),
('social_youtube', 'https://youtube.com/@pristinefinserve', 'text', 'social'),
