...
(
  ...
  'Comprehensive project funding solutions for infrastructure, manufacturing, and business projects.',
  '<p>Project funding is a specialized financing solution for large-scale business projects, infrastructure development, manufacturing units, and capital-intensive ventures. We provide end-to-end funding support from project appraisal to disbursement.</p><p>Our project finance solutions cover term loans, working capital, and bridge financing for new projects as well as expansion of existing ones.</p>',
  1000000, 500000000, 10.00, 16.00, 12, 360, '1-2% of loan amount',
  'reducing',
  '["Indian citizen or registered business entity","Viable project with clear business plan","Minimum 2 years business track record","Good credit score (700+)","Regulatory clearances in place","Strong management team"]',
  '["Project report & detailed business plan","Financial projections (3-5 years)","Identity & address proof of promoters","Business registration documents","GST returns (last 1 year)","Bank statements (last 12 months)","IT returns (last 3 years)","Collateral documents"]',
  '["Loan up to ₹50 Crore","Customized repayment structure","Moratorium period available","Term loan & working capital combo","Balance transfer facility","Dedicated project finance team"]',
  '["Tailored financing for project needs","Competitive interest rates","Flexible repayment options","Quick processing & disbursal","Minimal documentation","Expert financial advisory"]',
  '[{"question":"What types of projects can be funded?","answer":"Infrastructure, manufacturing, real estate, healthcare, education, and other commercial projects."},{"question":"Is moratorium period available?","answer":"Yes, moratorium of up to 12-18 months can be provided during project setup."},{"question":"What collateral is required?","answer":"Collateral depends on project type and risk profile. Typically project assets and personal guarantee are required."}]',
  'published', 7
),
(
  'CGTMSE',
  'cgtmse',
  'fas fa-shield-alt',
  'Get collateral-free loans up to ₹5 Crore under the CGTMSE scheme for MSMEs.',
  '<p>The Credit Guarantee Fund Trust for Micro and Small Enterprises (CGTMSE) provides collateral-free credit to MSMEs. This government-backed scheme eliminates the need for third-party guarantees, making it easier for small businesses to access formal credit.</p><p>We help you navigate the CGTMSE scheme and secure loans without the burden of providing collateral or third-party guarantees.</p>',
  100000, 50000000, 10.00, 18.00, 12, 120, '0.5-1% of loan amount',
  'reducing',
  '["Indian citizen (resident)","Business classified as MSME","Minimum 1 year business vintage","Good CIBIL score (700+)","Business should be profitable","Not defaulted on any existing loans"]',
  '["Identity proof: Aadhaar, PAN","Business registration documents","GST returns (last 1 year)","Bank statements (last 12 months)","IT returns (last 2 years)","MSME/Udyam registration certificate","Business address proof"]',
  '["Collateral-free loans up to ₹5 Crore","Government-backed guarantee","Quick processing","Minimal documentation","No third-party guarantee required","Available for new and existing businesses"]',
  '["Risk-free lending for MSMEs","Government credit guarantee support","Competitive interest rates","Quick approval process","Flexible repayment options","Dedicated MSME support team"]',
  '[{"question":"What is CGTMSE?","answer":"CGTMSE is a government scheme that provides collateral-free loans to MSMEs through a credit guarantee mechanism."},{"question":"What is the maximum loan amount?","answer":"Up to ₹5 Crore without collateral under the CGTMSE scheme."},{"question":"Who is eligible?","answer":"All MSMEs with valid Udyam registration, minimum 1 year business vintage, and good credit history."}]',
  'published', 8
),
(
  ...
  'working-capital-od-cc',
  'fas fa-exchange-alt',
  'Flexible overdraft and cash credit facilities to manage your daily business operations smoothly.',
  '<p>Working capital loans are essential for managing day-to-day business operations. Our Overdraft (OD) and Cash Credit (CC) facilities provide flexible funding to meet your operational expenses, purchase inventory, or manage cash flow gaps.</p><p>We offer both secured and unsecured working capital solutions tailored to your business needs.</p>',
  100000, 50000000, 9.50, 16.00, 12, 120, '0.5-1% of limit',
  'reducing',
  '["Indian citizen or registered business entity","Minimum 1 year business vintage","Annual turnover: ₹10 Lakh+","Good CIBIL score (700+)","Business should be operational","Sufficient margin money"]',
  '["Identity proof: Aadhaar, PAN","Business registration documents","GST returns (last 1 year)","Bank statements (last 12 months)","IT returns (last 2 years)","Stock statement (for CC)","Debtors & creditors statement"]',
  '["OD limit up to ₹5 Crore","CC limit up to ₹5 Crore","Pay interest only on utilized amount","Revolving credit facility","Quick renewal & enhancement","Both secured & unsecured options"]',
  '["Flexible credit facility","Interest on utilized amount only","Quick processing & renewal","Minimal documentation","No prepayment charges","Relationship manager support"]',
  '[{"question":"What is the difference between OD and CC?","answer":"OD (Overdraft) is a credit limit against collateral, while CC (Cash Credit) is a limit against inventory/receivables."},{"question":"What is the interest charged?","answer":"Interest is charged only on the utilized amount, not on the total limit sanctioned."},{"question":"How is the limit determined?","answer":"Based on your business turnover, stock/debtor position, and repayment capacity."}]',
  'published', 9
);
...
('Karnataka Bank', 'karnataka-bank', 'partners/logo-karnataka-bank.png', 'bank', 'Karnataka Bank is a leading bank in India offering personal, home, vehicle and business loans, savings accounts and digital banking services.', 'https://www.karnatakabank.com', 'active', 0),
...
('DCB Bank', 'dcb-bank', 'partners/logo-dcb-bank.svg', 'bank', 'DCB Bank is a leading bank in India offering personal, home, vehicle and business loans, savings accounts and digital banking services.', 'https://www.dcbbank.com', 'active', 28),
...
('AU Small Finance Bank', 'au-small-finance-bank', 'partners/logo-au-small-finance-bank.png', 'bank', 'AU Small Finance Bank is a leading bank in India offering personal, home, vehicle and business loans, savings accounts and digital banking services.', 'https://www.aubank.in', 'active', 31),
