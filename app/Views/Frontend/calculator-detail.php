    ...
    <div class="calculator-wrapper" data-aos="fade-up">
      <div class="calculator-inputs">
        <div class="form-group">
          ...
          <input type="number" class="form-control" id="emiLoanAmount" min="100000" max="10000000" step="50000" value="5000000" oninput="updateEMICalculator()">
        </div>

        <div class="form-group">
          <label>Interest Rate (% p.a.)</label>
          <input type="number" class="form-control" id="emiRate" min="5" max="20" step="0.1" value="8.5" oninput="updateEMICalculator()">
        </div>

        <div class="form-group">
          <label>Loan Tenure (Years)</label>
          <input type="number" class="form-control" id="emiTenure" min="1" max="30" step="1" value="20" oninput="updateEMICalculator()">
        </div>
    ...
    <div class="calculator-wrapper" data-aos="fade-up">
      <div class="calculator-inputs">
        <div class="form-group">
          ...
          <input type="number" class="form-control" id="eligIncome" min="10000" max="500000" step="5000" value="75000" oninput="updateEligibility()">
        </div>

        <div class="form-group">
          <label>Existing EMI (₹)</label>
          <input type="number" class="form-control" id="eligExisting" min="0" max="200000" step="1000" value="0" oninput="updateEligibility()">
        </div>

        <div class="form-group">
          <label>Loan Tenure (Years)</label>
          <input type="number" class="form-control" id="eligTenure" min="1" max="30" step="1" value="20" oninput="updateEligibility()">
        </div>

        <div class="form-group">
          <label>Interest Rate (% p.a.)</label>
          <input type="number" class="form-control" id="eligRate" min="5" max="20" step="0.1" value="8.5" oninput="updateEligibility()">
        </div>
      </div>
...
(function() {
  ...
  function updateEligibility() {
    ...
    var years = parseFloat(document.getElementById('eligTenure').value);
    ...
    <div class="calculator-wrapper" data-aos="fade-up">
      <div class="calculator-inputs">
        <div class="form-group">
          ...
          <input type="number" class="form-control" id="sipAmount" min="500" max="100000" step="500" value="5000" oninput="updateSIP()">
        </div>

        <div class="form-group">
          <label>Expected Return (% p.a.)</label>
          <input type="number" class="form-control" id="sipRate" min="1" max="30" step="0.25" value="12" oninput="updateSIP()">
        </div>

        <div class="form-group">
          <label>Time Period (Years)</label>
          <input type="number" class="form-control" id="sipTenure" min="1" max="40" step="1" value="10" oninput="updateSIP()">
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="calculator-wrapper" data-aos="fade-up">
      <div class="calculator-inputs">
        <div class="form-group">
          <label>Loan Amount (₹)</label>
          <input type="number" class="form-control" id="cmpAmount" min="100000" max="10000000" step="50000" value="1000000" oninput="updateComparison()">
        </div>

        <div class="form-group">
          <label>Loan Interest Rate (% p.a.)</label>
          <input type="number" class="form-control" id="cmpRate" min="5" max="20" step="0.1" value="10.5" oninput="updateComparison()">
        </div>

        <div class="form-group">
          <label>Loan Tenure (Years)</label>
          <input type="number" class="form-control" id="cmpTenure" min="1" max="30" step="1" value="5" oninput="updateComparison()">
        </div>

        <div class="form-group">
          <label>SIP Expected Return (% p.a.)</label>
          <input type="number" class="form-control" id="cmpSipRate" min="1" max="30" step="0.25" value="12" oninput="updateComparison()">
        </div>
      </div>
    ...
    <div class="calculator-wrapper" data-aos="fade-up">
      <div class="calculator-inputs">
        <div class="form-group">
          ...
          <input type="number" class="form-control" id="lumpAmount" min="10000" max="10000000" step="10000" value="100000" oninput="updateLumpsum()">
        </div>

        <div class="form-group">
          <label>Expected Return (% p.a.)</label>
          <input type="number" class="form-control" id="lumpRate" min="1" max="30" step="0.25" value="12" oninput="updateLumpsum()">
        </div>

        <div class="form-group">
          <label>Time Period (Years)</label>
          <input type="number" class="form-control" id="lumpTenure" min="1" max="40" step="1" value="5" oninput="updateLumpsum()">
        </div>
      </div>
