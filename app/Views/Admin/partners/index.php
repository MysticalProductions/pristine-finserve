...
<div class="card">
  <div class="card-body" style="padding:var(--space-4) var(--space-6);border-bottom:1px solid var(--border);">
    <form method="GET" action="/admin/partners" style="display:flex;gap:var(--space-3);align-items:center;">
      <div style="flex:1;position:relative;">
        ...
        <input type="text" name="search" class="form-control" placeholder="Search partners by name, type..." value="<?= htmlspecialchars($_GET['search'] ?? '') ?>" style="padding-left:36px;">
      </div>
      <button type="submit" class="btn btn-navy btn-sm"><i class="fas fa-search"></i> Search</button>
      <?php if (!empty($_GET['search'])): ?>
        <a href="/admin/partners" class="btn btn-outline btn-sm"><i class="fas fa-times"></i> Clear</a>
      <?php endif; ?>
    </form>
  </div>
